...
pip install requests langchain langchain-community langchain-experimental chromadb sentence-transformers torch pypdf tavily-python duckduckgo-search psutil pytest
deactivate
